...
#define BANNER_BOMB4 "sprite/bomb4.png"
#define BANNER_BOMB3 "sprite/bomb3.png"
#define BANNER_BOMB2 "sprite/bomb2.png"
#define BANNER_BOMB1 "sprite/bomb1.png"
...
static void banner_load()
{
	...
	banner_bomb = image_load(BANNER_BOMB1);
}
...
static void map_load()
{
	...
	explosion = image_load(BOMB_TTL0);
}

static void bomb_load()
{
	bomb[0] = image_load(BOMB_TTL0);
...
{ // REPRISE DES DEUX FONCTIONS AU DESSUS
...
SDL_Surface *sprite_get_bomb(short ttl)
{ // reprise de la fonction du dessus
	assert(bomb[ttl]);
	return bomb[ttl];
}
